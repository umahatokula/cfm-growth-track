...
class Video extends Model
{
     ...
     */
    public $table = 'umaha_courses_videos';
    ...
    public $attributeNames = [
        'title' => 'umaha.courses::lang.plugin.models.video.attributes.title',
        'youtube_video_id' => 'umaha.courses::lang.plugin.models.video.attributes.yt_watch'
    ];
    ...
    public $hasManyThrough = [
        'groups' => [
            ...
            'through' => 'Umaha\Courses\Models\Playlist'
        ],
    ];
    public $belongsTo = [];
    public $belongsToMany = [
        ...
        'playlists' => [
            ...
            'table' => 'umaha_courses_playlist_video',
            'key'      => 'video_id',
            'otherKey' => 'playlist_id'
        ],
        'categories' => [
            'Umaha\Courses\Models\Category',
            'table' => 'umaha_courses_category_video',
            'key'      => 'video_id',
